...
def bot_sys_stats():
    ...
    for download in download_dict.values():
        ...
        if status in MirrorStatus.STATUS_QUEUEDL or status in MirrorStatus.STATUS_QUEUEUP:
            ...
            seed += 1
    bmsg = f'______Zx Bot Info______\n\n'
...
async def stats(_, message, edit_mode=False):
    ...
    bot_stats = f'<b><i><u>Zx Bot Statistics</u></i></b>\n\n'\
    ...
    sys_stats = f'<b><i><u>Zx System Statistics</u></i></b>\n\n'\
...
async def send_bot_limits(_, query):
    ...
    bot_limit = f'<b><i><u>Zx Bot Limitations</u></i></b>\n' \
