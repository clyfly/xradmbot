...
rawowners = "<h1 style='text-align: center'>See my Channel <a href='https://telegram.me/xyradch'>@Telegram</a><br><br>By<br><br><a href='https://github.com/Dawn-India/Z-Mirror'>Z-Mirror</a></h1>"
...
<body>
    ...
    <header>
        ...
        <div class="social">
            ...
            <a href="https://telegram.me/xyradch"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
